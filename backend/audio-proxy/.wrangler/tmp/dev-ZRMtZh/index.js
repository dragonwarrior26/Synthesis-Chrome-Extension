...
// .wrangler/tmp/bundle-bVTg8Y/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-bVTg8Y/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-bVTg8Y/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var import_ytdl_core = __toESM(require_Browser());
var corsHeaders = {
...
async function getAudioInfo(videoId) {
  try {
    const info3 = await (0, import_ytdl_core.getInfo)(videoId);
    const audioFormats = (0, import_ytdl_core.filterFormats)(info3.formats, "audioonly");
